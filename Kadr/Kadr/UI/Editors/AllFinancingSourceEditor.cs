...
namespace Kadr.UI.Editors
{
    ...
    public class AllFinancingSourceEditor : System.Drawing.Design.UITypeEditor
    {
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            using (Common.ListSelectDialog<Kadr.Data.FinancingSource> dlg = new Kadr.UI.Common.ListSelectDialog<Kadr.Data.FinancingSource>())
            {
                ...
                dlg.DataSource =
                    Kadr.Controllers.KadrController.Instance.Model.FinancingSources.OrderBy(finSource => finSource.FinancingSourceName);
