namespace Kadr.UI.Forms
{
    partial class TimeSheetsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.EditTimeSheetBtn.ToolTipText = "Редактировать табель";
            ...
            this.DelTimeSheetBtn.ToolTipText = "Удалить табель";
            ...
            this.btnFillingReport.ToolTipText = "Открыть отчет по заполнению табеля";
