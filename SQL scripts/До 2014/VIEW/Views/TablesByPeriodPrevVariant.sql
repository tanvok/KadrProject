...
--select * from [dbo].[GetPlanStaffByPeriod]('31.03.2011','31.03.2011') where idPlanStaff=172
...
BEGIN
	...
	WHERE 
		((PlanStaff.DateBegin<=@PeriodBegin AND (PlanStaff.DateEnd>=@PeriodBegin OR PlanStaff.DateEnd IS NULL))
								...
								--OR (PlanStaff.DateEnd=@PeriodBegin)		  
RETURN
END

GO

--select * from [dbo].[GetFactStaffByPeriod]('20.06.2010','20.06.2010')
...
BEGIN
	...
	INSERT INTO @Result
	SELECT FactStaff.id, idPlanStaff, idEmployee, idTypeWork, StaffCount, IsReplacement
...
--select * from [dbo].[GetStaffByPeriod]('01.02.2011','12.02.2011') WHERE idDepartment=143 idPlanStaff=172
...
--select * from [dbo].[GetStaffByPeriod]('09.02.2011','12.02.2011') WHERE idDepartment=143 idPlanStaff=172
--select * from [GetStaffByPeriod]('19.09.2010','19.09.2010')
ALTER FUNCTION [dbo].[GetStaffByPeriod] 
(
@PeriodBegin	DATETIME,
